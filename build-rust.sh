...
lipo target/aarch64-apple-ios-sim/release/libfluvio_client_swift.a target/x86_64-apple-ios/release/libfluvio_client_swift.a -create -output target/libfluvio_client_swift.a

swift-bridge-cli create-package \
  --bridges-dir ./generated \
  --out-dir FluvioClientSwift \
  --ios target/aarch64-apple-ios/release/libfluvio_client_swift.a \
  --simulator target/libfluvio_client_swift.a \
